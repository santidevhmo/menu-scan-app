...
export interface EnrichedItem extends ExtractedItem {
   ...
   * null, and a 2026-08-11 run over 213 real items measured 199 of them coming
   * back with no count at all. Forcing the field is a mechanism change, not a
   * fifth wording - and it MEASURED BETTER: 0-3/96 at 12.0-12.5% against the
   * previous best's 2-3/96 at 14.3-14.5%, over 4 runs x 3 draws.
   *
    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          // force is 5 for 7. The model must classify every dish now - 1 means
