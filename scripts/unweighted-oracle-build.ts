...
const DRAFTS: Draft[] = [
  ...
  // avocado, a smear of cream cheese - nothing close to a solid protein portion).
  {
    ...
    assumed:
      ...
      "Approved 2026-08-22." +
      ' DERIVATION: Rice 140 g (FDC 2710788) + nori 3 g (FDC 2709988) + tuna ~50 g (FDC 2706308, filled, "spicy" read as a prep style with no separate ingredient) + shrimp ~40 g (FDC 2706449, topped) + avocado ~40 g (FDC 2709223, topped) + eel-sauce glaze ~10 g (FDC 2707442 soy sauce, proxy for "salsa anguila" at garnish scale). Totals ~283 g, 24 P / 49 C / 7 F.',
    retrieved_at: "2026-08-22",
  },
  {
    name: "Fildeflex",
    ...
    assumed:
      ...
      " DERIVATION: Rice 150 g (FDC 2710788, filled-only convention per Vegan Roll) + nori 3 g (FDC 2709988) + salmon ~60 g (FDC 2706286 baked/broiled, the dominant filling) + cream cheese 30 g (FDC 2705760) + cucumber 30 g (FDC 2709784) + sesame ~5 g (FDC 2707586, coating). Totals ~278 g, 23 P / 48 C / 25 F.",
    retrieved_at: "2026-08-22",
  },
  {
    name: "Avocado",
    ...
    assumed:
      ...
      " DERIVATION: Rice 140 g (FDC 2710788) + nori 3 g (FDC 2709988) + shrimp ~45 g (FDC 2706449, filled) + cream cheese 30 g (FDC 2705760, filled) + cucumber 30 g (FDC 2709784, filled) + avocado ~45 g (FDC 2709223, topped - the name-driving ingredient). Totals ~293 g, 13 P / 52 C / 18 F.",
    retrieved_at: "2026-08-22",
  },
  {
    name: "Tuna Especial",
    ...
    assumed:
      ...
      " DERIVATION: Rice 140 g (FDC 2710788) + nori 3 g (FDC 2709988) + cream cheese 30 g (FDC 2705760, filled) + avocado 40 g (FDC 2709223, filled) + tuna ~50 g (FDC 2706308, topped) + masago ~8 g (FDC 175132 fish roe, topped) + mayonnaise ~8 g (FDC 2710204, topped). Totals ~279 g, 21 P / 47 C / 23 F.",
    retrieved_at: "2026-08-22",
  },
  {
    name: "Salmón Samba",
    ...
    assumed:
      ...
      ' DERIVATION: Rice 140 g (FDC 2710788) + nori 3 g (FDC 2709988) + tuna 40 g (FDC 2706308, filled) + avocado 40 g (FDC 2709223, filled) + salmon ~50 g (FDC 2706286 baked/broiled, topped) + ponzu glaze ~10 g (FDC 2707442 soy sauce, proxy for "salsa spicy ponzu" at garnish scale). Totals ~283 g, 29 P / 46 C / 16 F.',
    retrieved_at: "2026-08-22",
  },
  {
    name: "Duplex",
    ...
    assumed:
      ...
      "2026-08-22." +
      ' DERIVATION: Rice 140 g (FDC 2710788) + nori 3 g (FDC 2709988) + Tampico sauce ~25 g (FDC 2710176 "Fry sauce" - Santiago\'s ruling 2026-08-22 that "Tampico" is a sauce, treated as a generic average the same way "vinagreta de la casa" uses FDC 2710195 elsewhere in the oracle; no protein is assumed inside it) + avocado 35 g (FDC 2709223, filled) + cream cheese 25 g (FDC 2705760, filled) + cucumber 25 g (FDC 2709784, filled) + shrimp 45 g (FDC 2706449, topped) + salmon 45 g (FDC 2706286 baked/broiled, topped). Totals ~343 g, 24 P / 52 C / 37 F.',
    retrieved_at: "2026-08-22",
  },
  {
    ...
    assumed:
      ...
      "protein/piece. Approved 2026-08-22." +
      ' DERIVATION: Rice 140 g (FDC 2710788) + nori 3 g (FDC 2709988) + Tampico sauce ~30 g (FDC 2710176 "Fry sauce" - the menu names ONLY "Tampico" as the interior, no protein stated there, so no protein is assumed inside it per the assumed-ingredient rule) + tuna ~55 g (FDC 2706308, topped, "picado" = chopped) + spicy-sauce glaze ~10 g (FDC 2710176, same generic sauce reused at garnish scale for "salsa spicy") + masago ~8 g (FDC 175132 fish roe, topped). Totals ~246 g, 20 P / 45 C / 24 F - the lightest of the seven because all of the stated protein sits in the topping, none in the filling.',
    retrieved_at: "2026-08-22",
  },
  ...
  // --- Round 2, Task 6: the two bistro pastas and three andaluz one-offs. ---
  {
    ...
    assumed:
      ...
      ' DERIVATION: Decomposed, same method as FETUCCINI ALFREDO/PASTA ESPECIAL: 230 g pasta (FDC 2708357) + 100 g tomato-cream sauce (FDC 2709749 "Vodka sauce with tomatoes and cream" - the FNDDS match for "crema de tomate") + 3 g dried chile de árbol (FDC 168570, "un toque" = a touch, flavor-scale only) + 40 g spinach (FDC 2709614) + 25 g feta (FDC 2705714). Totals 398 g, 20.8 P / 78.6 C / 13.9 F.',
    retrieved_at: "2026-08-22",
  },
  {
    ...
    assumed:
      ...
      "decomposed-ingredient method carried from CARBONARA/PASTA ESPECIAL/FETUCCINI ALFREDO, all " +
      "already ruled on this menu. Approved 2026-08-22." +
      ' DERIVATION: Decomposed, same method as FETUCCINI ALFREDO/PASTA ESPECIAL: 230 g pasta (FDC 2708357) + 40 g bell pepper (FDC 2709800) + 40 g mushroom (FDC 2709793) + 35 g deli ham (FDC 2706206) + 100 g cheese sauce (FDC 2705808, the FNDDS match for "salsa cremosa a base de quesos"). Totals 445 g, 23.7 P / 82.1 C / 16.9 F.',
    retrieved_at: "2026-08-22",
  },
  {
    name: "MEDITERRÁNEA",
    ...
    assumed:
      ...
      ' DERIVATION: 11 named ingredients, decomposed: 100 g lettuce (FDC 2709789) + 30 g cucumber (FDC 2709784) + 30 g corn (FDC 168540) + 30 g queso fresco (FDC 2705745 - the closest FNDDS match to "queso panela"; no exact panela record exists) + 15 g olives (FDC 169095) + 40 g cherry tomato (FDC 2709719) + 30 g avocado (FDC 2709223) + 30 g mushroom (FDC 2709793) + 30 g asparagus (FDC 168390) + 15 g almonds (FDC 168596) + 30 g olive-oil/balsamic dressing (FDC 2710203, the same Italian-dressing record already used for ENSALADA GRIEGA). Totals 380 g (absolute macros 13.71 P / 26.24 C / 27.53 F), 3.6 P / 6.9 C / 7.2 F per 100 g.',
    retrieved_at: "2026-08-22",
  },
  {
    name: "QUESABONELESS",
    ...
    assumed:
      ...
      ' DERIVATION: "Dos" = 2 tortillas, a stated count: 80 g flour tortilla (FDC 2707824, 2x40g) + 40 g queso chihuahua (FDC 2705774 - manchego has NO FDC record at any venue, confirmed by search; chihuahua is the closest melting-cheese analog already used elsewhere on this menu) + 90 g breaded fried chicken (FDC 170756, reused from TIRAS DE POLLO, already ruled on this exact menu). "Salsa al gusto" (sauce to taste) is explicitly optional/unspecified and not separately weighed, same treatment as the rolls\' negligible garnishes. Totals 210 g, 36.4 P / 47.2 C / 29.5 F.',
    retrieved_at: "2026-08-22",
  },
  {
  ...
  // and el-marcos - the final batch, completing the 44. ---
  {
    ...
    assumed:
      ...
      ' DERIVATION: 55 g FDC 2705825 "Beef, steak, chuck" (diezmillo) + 28 g FDC 2707823 "Tortilla, corn" (reused from TACO PORCO/EL CAPRICHO, same published FNDDS portion). No cheese or vegetable is named, unlike the two already-ruled tacos, so this totals notably lighter (83 g vs their 120-130 g) - ruled on the menu text alone, not adjusted for the pre-registered prediction that the gap shrinks.',
    retrieved_at: "2026-08-22",
  },
  {
    ...
    assumed:
      ...
      ' DERIVATION: 55 g FDC 2705827 "Beef, steak, flank" (arrachera - same cut and same weight TACO EL CAPRICHO already uses) + 28 g FDC 2707823 corn tortilla. No cheese or vegetable named. Same sizing note as TACO BRASERO.',
    retrieved_at: "2026-08-22",
  },
  {
    name: "TOSTA ATUM",
    ...
    assumed:
      ...
      " DERIVATION: 13 g tostada shell (FDC 167525, published portion) + 70 g seared tuna (FDC 2706308) + 25 g mushroom/portobello (FDC 2709793) + 25 g roasted corn (FDC 168540) + 25 g cucumber (FDC 2709784) + 25 g jicama (FDC 2709787) + 10 g ponzu glaze (FDC 2707442 soy sauce proxy) + 3 g sesame (FDC 2707586)." +
      " TUNA VARIANT AUDITED 2026-08-22 AND THE RAW RECORD IS KEPT. Ruled by the agent, NOT by Santiago, who delegated it explicitly; it preserves the existing band, so it carries no re-scoring risk. FNDDS publishes four tuna cells: raw 2706308 (P 24.4 / F 0.49), cooked 2706310 (P 30.31 / F 5.14), NFS 2706309 and canned 2706311. ☠️ NFS IS BYTE-IDENTICAL TO CANNED (both P 19 / C 0.08 / F 0.94, 85 kcal) - FNDDS's not-further-specified tuna defaults to the tin, so NFS is NOT a neutral middle option for a seared steak and was rejected. Between raw and cooked: protein rises 24.4 -> 30.31 (+24%, consistent with ~20% water loss) but fat rises 0.49 -> 5.14, a 10x jump water loss cannot explain - the cooked cell carries ADDED COOKING FAT. The menu names no oil and searing does not require it, so under the assumed-ingredient rule (definitional only) that fat stays out. 'Sellado' is seared-outside, rare-centred, so its water content sits near raw. Raw is the closest cell once added cooking fat is excluded. ⚠️ It still understates: a real seared portion sits between raw and cooked on protein. The dish's 196 g total is corroborated - FNDDS 2708508 'Taco or tostada salad with meat' publishes portions from 122 to 420 g, so 196 g is inside the published range at the low end.",
    retrieved_at: "2026-08-22",
  },
  {
    ...
    assumed:
      ...
      ' DERIVATION: 13 g tostada shell (FDC 167525) + 60 g sirloin/picanha (FDC 2705833 - no dedicated picanha record exists) + 60 g black beans (FDC 2707359, the FNDDS match for "feijoada") + 25 g bell pepper mix (FDC 2709800).',
    retrieved_at: "2026-08-22",
  },
  {
    ...
    assumed:
      ...
      "Approved 2026-08-22." +
      ' DERIVATION: Dessert. 60 g crepe (FDC 2708341) + 30 g caramel candy (FDC 2710354, the proxy for "dulce de leche" - no dedicated FDC record exists) + 20 g chocolate syrup (FDC 2710276) + 60 g vanilla ice cream (FDC 2705629 "Ice cream, NFS").',
    retrieved_at: "2026-08-22",
  },
  {
    name: "CHILE RELLENO",
    ...
    assumed: "Name-only dish, no menu description. Approved 2026-08-22." +
      ' DERIVATION: Name-only, kept answerable (Task 5 - "the name is the recipe"). No FDC "chile relleno" record exists; FDC 2710045 "Stuffed jalapeno pepper" is the closest battered/fried/cheese-stuffed-pepper analog. 160 g, a defensible single-serving stuffed poblano plus batter/sauce.',
    retrieved_at: "2026-08-22",
  },
  {
    ...
    assumed: "Name-only dish, no menu description. Approved 2026-08-22." +
      ' DERIVATION: Name-only, kept answerable (Task 5 - "orden de" pins a portion convention). 5 x 28 g FDC 2707823 corn tortilla (the same published-portion record the tacos use), 5 being a defensible middle count for a tortilla-basket order.',
    retrieved_at: "2026-08-22",
  },
  {
    name: "DE INDIO",
    ...
    assumed:
      ...
      ' DERIVATION: "Dos huevos" = 2 eggs, 110 g (the established el-marcos omelette convention) + 80 g gordita/huarache base (FDC 2707818, the closest FNDDS analog to a huarache) + 60 g refried beans (FDC 2707396) + 30 g salsa verde (FDC 2709743) + 15 g crema (FDC 2705614) + 15 g onion (FDC 2709795) + 4 g cilantro (FDC 2709782).',
    retrieved_at: "2026-08-22",
  },
  {
    ...
    assumed: '"(Orden de dos)" - no further description. Approved 2026-08-22.' +
      ' DERIVATION: "(Orden de dos)" = 2 pieces, stated. 2 x 43 g FDC 2707654 "Roll, white, soft" (published FNDDS portion for a medium/regular roll) - plain, no other ingredient named.',
    retrieved_at: "2026-08-22",
  },
  {
    ...
    assumed:
      ...
      ' DERIVATION: Same 2 x 43 g roll base as BISQUETS DEL CENTRO + 30 g berry jam/preserve (FDC 169641 "Jams and preserves") for "frutos rojos".',
    retrieved_at: "2026-08-22",
  },
  {
    ...
    assumed:
      ...
      " DERIVATION: Name-only, ruled answerable by Santiago (Task 5 edge case - the 2-egg base is a menu-wide convention from its 3 sibling omelettes, not this dish's own text). 110 g egg (FDC 2707158) + 40 g shrimp (FDC 2706363) + 40 g marlin (FDC 2706301 \"Fish, swordfish\" - no dedicated marlin record exists, swordfish is the closest billfish analog). Lands above FNDDS's largest published omelette portion (170 g), same pattern round 1 flagged for all 3 sibling omelettes (183-222 g) - not extended blindly: this 190 g comes from the 2 named proteins alone, at a magnitude comparable to the siblings' fillings, not from copying a number.",
    retrieved_at: "2026-08-22",
  },
];
